...
namespace _01_MainSubjects
{
    public class Program
    {
        ...
        {
            {
                // #region ile #endregion işaretleri arası yazılan kod parçacıkları kendi içinde bir küme olarak algılanır. Çok kodlu projelerde bu kısımlar önemli yer alabilir. 
                #region YazdırmaKomutları

                //Write() metodu sonunda imleç aynı satırda kalmaya devam ederken WriteLine() metodu sonunda otomatik bir alt satıra iner.
